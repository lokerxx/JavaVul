...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.83"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.83 靶场测试页", "/fastjson1.2.83-process", new String[]{}, "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}");
    }
