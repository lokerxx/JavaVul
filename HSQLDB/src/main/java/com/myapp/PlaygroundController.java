...
public class PlaygroundController {
    ...
    @ResponseBody
    public String index() {
        return "<!DOCTYPE html><html lang=\"zh-CN\"><head><meta charset=\"UTF-8\"><title>HSQLDB Playground</title>" + style() +
                "</head><body><div class=\"container\"><h1>HSQLDB Playground</h1><p class=\"hint\">默认 payload 使用 <code>test' OR '1'='1</code>，这样更容易看到漏洞版返回多条、修复版返回空结果的差异。</p>" +
                panel("attack","HSQLDB attack","/hsqldb?username=test%27%20OR%20%271%27%3D%271") +
                panel("repair","HSQLDB repair","/hsqldb_repair?username=test%27%20OR%20%271%27%3D%271") +
                "</div><script>" +
